...
![מחיר בפועל מול מחיר חזוי](assets/price_model_actual_vs_predicted.png)
...
![משפך זיהוי Hidden Gems](assets/hidden_gem_funnel.png)
...
**ויזואליזציה:** `clustering/scatter_k4.png` (פיזור גיאוגרפי, צביעה לפי cluster, מרכזים מסומנים).

![Clusters של Hidden Gems](../clustering/scatter_k4.png)
